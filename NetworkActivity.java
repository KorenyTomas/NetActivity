        ...
        protected void onPostExecute(final List<Entry> result) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, final View view,
                    ...
                    Log.d("Clicked", result.get(position).kod);
                    Intent resultIntent = getIntent();
                    resultIntent.putExtra("selectedKod", result.get(position).kod);
                    resultIntent.putExtra("selectedKurz", result.get(position).kurz);
                    resultIntent.putExtra("selectedMena", result.get(position).mena);
                    resultIntent.putExtra("selectedMnozstvi", result.get(position).mnozstvi);
                    resultIntent.putExtra("selectedZeme", result.get(position).zeme);
                    Log.d("extra", "OK");
                    setResult(Activity.RESULT_OK, resultIntent);
                    finish();

                    //startActivity(new Intent(NetworkActivity.this, NetDetail.class));
